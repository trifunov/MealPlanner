...
namespace MealPlanner.Data.Migrations
{
    ...
    [Migration("20220316131157_Added_DeliveredDate-SoftMeal")]
    partial class Added_DeliveredDateSoftMeal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealPlanner.Data.Models.DeliveryLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MealPlanner.Data.Models.SoftMeal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("SoftMealDetailId");

                    b.HasKey("Id");

                    b.HasIndex("EmployeeId");

                    b.HasIndex("SoftMealDetailId");

                    b.ToTable("SoftMeals");
                });

            modelBuilder.Entity("MealPlanner.Data.Models.SoftMealDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MealPlanner.Data.Models.SoftMeal", b =>
                {
                    ...
                    b.HasOne("MealPlanner.Data.Models.SoftMealDetail", "SoftMealDetail")
                        .WithMany("SoftMeals")
                        .HasForeignKey("SoftMealDetailId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
